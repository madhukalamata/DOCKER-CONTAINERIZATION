...
| IMAGE_REPO        | madhu/python-demoapp |
| IMAGE_TAG         | latest                 |
...
Public container image is [available on GitHub Container Registry](https://github.com/users/madhu/packages/container/package/python-demoapp)

Run in a container with:

```bash
docker run --rm -it -p 5000:5000 ghcr.io/madhu/python-demoapp:latest
```
